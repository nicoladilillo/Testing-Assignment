...
set_patterns -external patterns_update.stil
run_simulation -update

write_patterns patterns_new.stil -external -replace  -format stil -cycle_count -nopatinfo -serial -cellname parallel
